...
public class MainActivity extends AppCompatActivity {
    ...
    public Stack<LetterTile> placedTiles = new Stack<>();
    ...
    public boolean onStartGame(View view) {
        ...
        int w1= random.nextInt(words.size());
        int w2= random.nextInt(words.size());
        word1=words.get(w1);
        word2=words.get(w2);
        int l1=word1.length();
        int l2=word2.length();
        ...
        int i=0;
        while(l1>0 && l2>0){
            scrambleword=scrambleword+word1.charAt(i)+word2.charAt(i);
            l1--;
            l2--;
            i++;
        }
        while(l1>0){
            scrambleword+=word1.charAt(i);
            i++;
            l1--;
        }
        while (l2>0){
            scrambleword+=word2.charAt(i);
            i++;
            l2--;
        }
        for(i=scrambleword.length()-1;i>=0;i--){
            LetterTile letter = new LetterTile(this,scrambleword.charAt(i));
